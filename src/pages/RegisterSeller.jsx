  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-5 py-16">
      <div className="max-w-md w-full">
        <h1 className="font-display font-extrabold text-3xl text-ink">Create your seller account</h1>
        <p className="text-ink-soft mt-2">Create your store, sell products, and grow your business.</p>
